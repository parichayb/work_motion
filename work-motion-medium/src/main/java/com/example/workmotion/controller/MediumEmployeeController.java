...
public class MediumEmployeeController {
  ...
  private void createLinks(Employee savedEmployee) {
    Link link = linkTo(methodOn(MediumEmployeeController.class).getEmployee(savedEmployee.getId())).withSelfRel();
    ...
    Link eventLink = linkTo(methodOn(MediumEmployeeController.class).updateEmployeeState(savedEmployee.getId(), null))
